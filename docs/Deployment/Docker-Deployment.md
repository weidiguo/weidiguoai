...
We provide [Docker Images][docker-release-link] for you to deploy 微帝国AI service on your private device.
...
Use the following command to start 微帝国AI service with one click:
...
> - For a complete list of environment variables supported by 微帝国AI, please refer to the [Environment Variables](https://github.com/lobehub/lobe-chat/wiki/Environment-Variable.zh-CN) section.
