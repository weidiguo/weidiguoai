...
微帝国AI provides additional configuration options during deployment, which can be set using environment variables
...
- Type: Optional
- Description: Add a password to access the 微帝国AI service, ; you can set a long password to avoid leaking. If this value contains a comma, it is a password array.
- Default: `-`
...
- Type: Optional
- Description: The index address of the 微帝国AI plugin market. If you have deployed the plugin market service yourself, you can use this variable to override the default plugin market address
...
- Type: Optional
- Description: The index address of the 微帝国AI role market. If you have deployed the role market service yourself, you can use this variable to override the default plugin market address
