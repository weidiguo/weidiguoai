...
Welcome to the 微帝国AI technical development getting started guide. 微帝国AI is an AI conversation application built on the Next.js framework, which integrates a series of technology stacks to achieve diverse functions and features. This guide will provide a detailed introduction to the main technical components of 微帝国AI and how to configure and use these technologies in your development environment.
...
The core technology stack of 微帝国AI includes:
...
The folder directory structure of 微帝国AI is as follows:
